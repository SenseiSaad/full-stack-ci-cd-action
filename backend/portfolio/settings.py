...
# Nginx terminates public HTTPS and proxies to Gunicorn over local HTTP.
# Trust the forwarded scheme so Django builds CSRF/admin URLs as HTTPS.
...
# Supports both SQLite (development) and PostgreSQL (AWS RDS)
db_engine = os.getenv('DATABASE_ENGINE') or os.getenv('DB_ENGINE')
if db_engine == 'django.db.backends.postgresql' or os.getenv('DB_HOST') or os.getenv('DATABASE_HOST'):
    # AWS RDS PostgreSQL configuration
    DATABASES = {
        'default': {
            'ENGINE': 'django.db.backends.postgresql',
            'NAME': os.getenv('DB_NAME') or os.getenv('DATABASE_NAME', 'portfolio'),
